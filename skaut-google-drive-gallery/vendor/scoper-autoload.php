...
if (isset($GLOBALS['__composer_autoload_files_Sgdg_Vendor'])) {
...
if (isset($existingComposerAutoloadFiles)) {
    $GLOBALS['__composer_autoload_files_Sgdg_Vendor'] = $existingComposerAutoloadFiles;
} else {
    unset($GLOBALS['__composer_autoload_files_Sgdg_Vendor']);
}
